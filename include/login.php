<!-- 
                ...
                <div class="bars" id="first-modal">
                        <button id="m1" class="menu" onclick="this.classList.toggle('opened');this.setAttribute('aria-expanded', this.classList.contains('opened'))" aria-label="Main Menu">
